...
const getSlackInstallationById = async (id: any) => {
...
const updateSlackInstallation = async (id: any, data: Partial<SlackInstallationData>) => {
...
const deleteSlackInstallation = async (id: any) => {
